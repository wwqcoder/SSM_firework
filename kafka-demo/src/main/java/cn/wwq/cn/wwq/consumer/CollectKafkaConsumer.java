package cn.wwq.cn.wwq.consumer;
...
public class CollectKafkaConsumer {
    ...
    public CollectKafkaConsumer(String topic) {
        ...
        // 消费者的zookeeper 地址配置
        props.put("zookeeper.connect", "172.16.13.131:2181");
        // 消费者的broker 地址配置
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "172.16.13.131:9092");
        // 消费者组定义
        ...
        while (true){
            ...
            for (TopicPartition partition : records.partitions()) {
                ...
                for (int i = 0; i < size; i++) {
                    System.out.println("------->value:" + partitionRecords.get(i).value());
