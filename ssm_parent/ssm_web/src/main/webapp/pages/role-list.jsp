...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
									...
									<c:forEach items="${pageInfo.list}" var="role">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/role/addPermissionUI?id=${role.id}" class="btn bg-olive btn-xs">添加权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div class="box-footer">
						<div class="pull-left">
							<div class="form-group form-inline">
								...
								<select id="selector" onchange="gotoPage(1)" class="form-control">
		...
		<script type="text/javascript">
			...
			$("#selector option[value='${pageInfo.pageSize}']").prop("selected",true);
			...
			function gotoPage(page) {
				...
				var pageSize = $("#selector").val();
				location.href = "${pageContext.request.contextPath}/role/findAll?pageNum="+page+"&pageSize="+pageSize;
