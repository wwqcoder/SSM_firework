			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="table-box">
							...
							<div class="form-group form-inline">
								<div class="btn-group">
									<button type="button" class="btn btn-default" title="新建"
										onclick='location.href="${pageContext.request.contextPath}/order/ProductUI"'>
						...
						<form id="deleForm" action="${pageContext.request.contextPath}/order/deleByIds" method="post">
						<!--数据列表-->
							<table id="dataList"
									...
									<tr>
										...
										<td class="text-center">
											<button type="button" class="btn bg-olive btn-xs"
												onclick='location.href="${pageContext.request.contextPath}/order/editUI?id=${order.id}"'>修改</button>
											<button type="button" class="btn bg-olive btn-xs"
												onclick='dele(${order.id})'>删除</button>
										</td>
									</tr>
								</c:forEach>
	...
	<script type="text/javascript">
		function dele(id) {
			if (confirm("您确认要删除该订单吗？")){
				location.href = "${pageContext.request.contextPath}/order/dele?id="+id;
			}
		}
