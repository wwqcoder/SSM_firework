					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									id="datepicker-a6" value="${orders.product.departureTime }" name="product.departureTime">
							</div>
						</div>
				...
				<c:if test="${orders.orderStatus==1}">
					<div class="panel panel-default">
						...
						<div class="row data-type">
							...
							<div class="col-md-4 data text">在线支付-<input type="text" value="${orders.payType == 0 ?"支付宝":order.payType == 1 ?"微信":"其他"}" name="payType"></div>
